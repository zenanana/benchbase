...
public abstract class TPCCProcedure extends Procedure {
    ...
    public abstract void run(Connection conn, Random gen, int terminalWarehouseID, int numWarehouses, int next_id, int terminalDistrictLowerID, int terminalDistrictUpperID, int schedule, TPCCWorker w) throws SQLException;
